 ...
 * POST actions: create_csi
 * Payment recording is handled only by the Cashier POS collections API.
 * PUT actions: void
 * 
...
function handlePost($db, $action, $currentUser) {
    ...
    switch ($action) {
        case 'create_csi':
            ...
            break;
        case 'record_payment':
            Response::error('Payments must be recorded by the Cashier in POS Collections.', 403);
            break;
