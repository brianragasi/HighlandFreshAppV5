-- =====================================================
-- Highland Fresh Database - Azure MySQL Compatible
-- Converted from MariaDB 10.4 dump
-- Date: 2026-02-11 15:00:53
-- =====================================================
...
CREATE TABLE `batch_recalls` (
  ...
  `evidence_files` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `deliveries` (
  ...
  `return_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Stores item-level return info',
...
CREATE TABLE `payment_collections` (
  ...
  `payment_metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'check_number, check_bank, check_date, gcash_ref, bank_ref',
...
CREATE TABLE `production_runs` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `output_breakdown` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Stores unit breakdown: total_pieces, secondary_count, remaining_primary, etc.',
  `milk_batch_source` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `process_temperature` decimal(5,2) DEFAULT NULL,
  `process_duration_mins` int(11) DEFAULT NULL,
  `ingredient_adjustments` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `sales_transaction_items` (
  ...
  `discount_amount` decimal(12,2) DEFAULT 0.00,
  `line_total` decimal(12,2) NOT NULL,
  `inventory_deductions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
