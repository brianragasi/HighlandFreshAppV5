...
$checks = [
    ...
    'package prices allow no more than two decimal places' =>
        ...
        && str_contains($page, 'const maximumDecimals = context.packaged ? 2 : 6'),
    ...
    'Purchaser can update requested and manually added lines without clearing the PO' =>
        ...
        && str_contains($page, "mode: 'forecast'")
        && str_contains($page, 'applySavedSupplierPriceToPOLine(context')
        && !str_contains($page, "showToast('Supplier price list updated. The PO lines were refreshed.'"),
];
